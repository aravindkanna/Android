...
public class alarm extends ActionBarActivity {
    ...
    public void start(View view)
    {
        ...
        Toast.makeText(this, "This is alarm.", Toast.LENGTH_LONG).show();

        //TextView tv = (TextView) findViewById(R.id.alarmtv);
        //tv.setText("Hey hai..!!!");
        Tel.listen(MyListener , PhoneStateListener.LISTEN_SIGNAL_STRENGTHS);
    ...
    private class MyPhoneStateListener extends PhoneStateListener
    {
        ...
        public void onSignalStrengthsChanged(SignalStrength s)
        {
            ...
            if(global_cellid!=cellid || count==0)
            {
                ...
                TextView tv = (TextView) findViewById(R.id.alarmtv);
                TextView tv1 = (TextView) findViewById(R.id.strengthtv);
    ...
    {
        Intent intent = new Intent(this, stdb.class);
        startActivity(intent);
    }

    public void deletepage(View view)
    {
        Intent intent = new Intent(this, deleterow.class);
        startActivity(intent);
    }
